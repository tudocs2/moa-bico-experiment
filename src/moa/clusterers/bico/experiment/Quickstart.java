...
public class Quickstart {
	 ...
	 *            args[7] - input CSV split character (optional)
	 *            args[8] - seed (optional)
	 * 
	 */
	public static void main(String[] args) {
		...
		String splitChar = ",";
		if (args.length > 7) {
			splitChar = args[7].substring(0, 1);
		}
		if (splitChar.equals("S")) {
			splitChar = " ";
		}
		int seed = 0;
		if (args.length > 8) {
		...
		input.splitCharOption.setValue(splitChar);
